...
model_name = sys.argv[1] if len(sys.argv) > 1 else "/home/logic/Qwen/Qwen3-Embedding-0___6B/"
train_batch_size = 16
num_epochs = 4
output_dir = (
...
train_dataset = load_dataset("csv",data_files = "sts_mybench_data.csv")["train"]
eval_dataset = load_dataset("csv",data_files = "sts_mybench_data_test.csv")["train"]
test_dataset = load_dataset("csv",data_files = "sts_mybench_data_test.csv")["train"]
